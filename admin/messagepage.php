<?php
    ...
    */
    ...
    $all_messengers = Database::getAllMessengers();
                    ...
                    <div class="eric_card">
                        ...
                        <div class="body_div">
                            <ul>
                                ...
                                <li id="messengerli"><p><a href="#">All Messengers
                                            (<?php echo count($all_messengers); ?>)</a>
                                    </p></li>
                ...
                <div class="col-md-9">
                    <div id="message_div">
                        <table cellspacing="9px" id="all_messages">
                            ...
                            ?>
                            <caption><?php echo 'Page ' . $page . ' of ' . $numberOfPages; ?></caption>
                        </table>
                        <div class="text-center little-margin pagination"><?php include "Partitions/pagination.php"; ?></div>
                    </div>
                    <table id="all_users" class="invisible">
                        <?php
                            for ($j = 0; $j < count($all_messengers); $j++) {
                                $messenger = new Messenger($all_messengers[$j]);
                                ?>
                                <tr>
                                    <td><a class="delete_user" title="Delete User"
                                           href="controller/messagecontroller.php?id=<?php echo $messenger->getUserid(); ?>&messenger=1"><i
                                                    class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                    </td>
                                    <td><?php echo $messenger->getFirstname(); ?></td>
                                    <td><?php echo $messenger->getEmail(); ?></td>
                                    <td>Send an Email</td>
                                </tr>
                                <?php
                            }
